...
To illustrate how Painless works, let's load some hockey stars into an Elasticsearch index:
...
Alternatively, you can do the same thing using a script field instead of a function score:
